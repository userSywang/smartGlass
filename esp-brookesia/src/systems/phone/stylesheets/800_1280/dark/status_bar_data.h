...
/* Area */
#define ESP_BROOKESIA_PHONE_800_1280_DARK_STATUS_BAR_AREA_DATA(w_percent, align) \
    {                                                                     \
...
/* Status Bar */
#define ESP_BROOKESIA_PHONE_800_1280_DARK_STATUS_BAR_DATA()                                                      \
    {                                                                                                     \
        .main = {                                                                                         \
        ...
        .area = {                                                                                         \
            ...
            .data = {                                                                                     \
                ESP_BROOKESIA_PHONE_800_1280_DARK_STATUS_BAR_AREA_DATA(33, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_START),  \
                ESP_BROOKESIA_PHONE_800_1280_DARK_STATUS_BAR_AREA_DATA(34, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_CENTER), \
                ESP_BROOKESIA_PHONE_800_1280_DARK_STATUS_BAR_AREA_DATA(33, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_END),    \
            },                                                                                            \
        },                                                                                                \
