 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --size 72 --bpp 4 --format lvgl --no-compress --font lvgl\scripts\built_in_font\Montserrat-Medium.ttf --symbols 0123456789 --lv-font-name nav_font_72_digits -o apps\lens_react_ui\nav_font_72_digits.c
 ******************************************************************************/
...
#ifndef NAV_FONT_72_DIGITS
#define NAV_FONT_72_DIGITS 1
#endif

#if NAV_FONT_72_DIGITS
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t nav_font_72_digits = {
#else
lv_font_t nav_font_72_digits = {
#endif
