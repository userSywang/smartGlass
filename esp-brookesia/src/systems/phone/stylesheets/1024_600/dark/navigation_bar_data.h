...
#define ESP_BROOKESIA_PHONE_1024_600_DARK_NAVIGATION_BAR_DATA()                                                      \
    {                                                                                                         \
        .main = {                                                                                             \
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 80),                                                \
            .size_min = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 36),                                   \
            .size_max = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 60),                                   \
