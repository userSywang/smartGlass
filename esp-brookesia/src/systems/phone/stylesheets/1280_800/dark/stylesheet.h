...
/* Home */
#define ESP_BROOKESIA_PHONE_1280_800_DARK_HOME_DATA()                                    \
    {                                                                             \
        .status_bar = {                                                           \
            .data = ESP_BROOKESIA_PHONE_1280_800_DARK_STATUS_BAR_DATA(),                 \
            .visual_mode = ESP_BROOKESIA_STATUS_BAR_VISUAL_MODE_SHOW_FIXED,              \
        },                                                                        \
        .navigation_bar = {                                                       \
            .data = ESP_BROOKESIA_PHONE_1280_800_DARK_NAVIGATION_BAR_DATA(),             \
            .visual_mode = ESP_BROOKESIA_NAVIGATION_BAR_VISUAL_MODE_HIDE,           \
        },                                                                        \
        .app_launcher = {                                                         \
            .data = ESP_BROOKESIA_PHONE_1280_800_DARK_APP_LAUNCHER_DATA(),               \
            .default_image = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_image_large_app_launcher_default_112_112), \
        },                                                                        \
        .recents_screen = {                                                       \
            .data = ESP_BROOKESIA_PHONE_1280_800_DARK_RECENTS_SCREEN_DATA(),             \
...
/* Manager */
#define ESP_BROOKESIA_PHONE_1280_800_DARK_MANAGER_DATA()             \
    {                                                         \
        .gesture = ESP_BROOKESIA_PHONE_1280_800_DARK_GESTURE_DATA(), \
...
/* Phone */
#define ESP_BROOKESIA_PHONE_1280_800_DARK_STYLESHEET()               \
    {                                                         \
        .core = ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_DATA(),       \
        .home = ESP_BROOKESIA_PHONE_1280_800_DARK_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_1280_800_DARK_MANAGER_DATA(), \
    }
